...
const AddVanPart = ({ navigation }) => {
    ...
    const handleSubmit = (values, { resetForm }) => {
        ...
        const dataToSend = { ...values, image: image, ownerId: userData.userId, type: PRODUCT_TYPES.van, email:userData.email };
                        ...
                        {({ handleChange, handleBlur, handleSubmit, errors, isValid, values, touched }) => (
                            <View style={styles.FormView}>
                                ...
                                <TextInput
                                    ...
                                    placeholder={"Enter Your Part in RS"}
                                    placeholderTextColor={"#a1a1a1"}
